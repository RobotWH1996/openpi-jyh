...
import openpi.policies.cr100_policy as cr100_policy
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotCR100OpenDoorDataConfig(
            repo_id="lerobot/cr100_left_mp_byman_np_v3_edited",
            # lerobot_root="/home/yjh/.cache/huggingface/lerobot/lerobot/cr100_left_mp_byman_np_v3",
            base_config=DataConfig(prompt_from_task=True),
        ),
        save_interval=5000,
        batch_size=32,
    ...
    TrainConfig(
        ...
        policy_plugin=SARMRABCConfig(
            enabled=True,
            progress_path="/home/ubuntu/.cache/huggingface/lerobot/lerobot/cr100_2026_0408_temp/sarm_progress.parquet",
            head_mode="sparse",   # 或 "dense"
            kappa=0.01,
        ),
